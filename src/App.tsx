            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-red-600">Total Spent</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-green-600">Total Received</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">${(totalReceived - totalSpent).toFixed(2)}</div>
                </CardContent>
              </Card>
            </div>
          )}
        ...
        {cleanedTransactions.length > 0 && (
          <Tabs defaultValue="raw" className="w-full">
            <TabsList className="grid w-full grid-cols-6">
              ...
              <TabsTrigger value="categories-amount">Categories by $</TabsTrigger>
              <TabsTrigger value="categories-count">Categories by Count</TabsTrigger>
            ...
            <TabsContent value="raw" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>All columns from the original CSV file</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="cleaned" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Important columns only: Target name, Amount, Category, Direction, Date</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="categories-amount" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Spending categories sorted by total amount spent</CardDescription>
                </CardHeader>
                <CardContent>
                  <SummaryTable data={sortByAmount(categorySummaries)} type="category" />
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="categories-count" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Spending categories sorted by number of transactions</CardDescription>
                </CardHeader>
                <CardContent>
                  <SummaryTable data={sortByCount(categorySummaries)} type="category" />
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="targets-amount" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Vendors/targets sorted by total amount spent</CardDescription>
                </CardHeader>
                <CardContent>
                  <SummaryTable data={sortByAmount(targetSummaries)} type="target" />
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="targets-count" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Vendors/targets sorted by number of transactions</CardDescription>
                </CardHeader>
                <CardContent>
                  <SummaryTable data={sortByCount(targetSummaries)} type="target" />
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
          ...
          <div className="text-center py-12">
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-2xl mx-auto">
              ...
              <p className="text-sm text-red-600">
                Make sure your CSV files are placed in the <code className="bg-red-100 px-1 rounded">public/data/YYYY/M/</code> folder structure.
              </p>
            </div>
          </div>
        )}
